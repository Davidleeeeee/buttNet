...
class BasicDataset(Dataset):
    ...
    @classmethod
    def preprocess(cls, pil_img, is_mask, need_patch):
        w, h = pil_img.size
    ...
    def __getitem__(self, idx):
        ...
        origen = self.preprocess(img, is_mask=False, need_patch=False)
        img = self.preprocess(img, is_mask=False, need_patch=True)
        mask = self.preprocess(mask, is_mask=True, need_patch=False)
